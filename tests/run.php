...
assert_true(\Crm\InventarioStock::likeNeedle('12852-48') === '%12852-48%', 'likeNeedle conserva guion de SKU');
assert_true(\Crm\InventarioStock::likeNeedle('a%b_c') === '%a!%b!_c%', 'likeNeedle escapa % y _ con !');
assert_true(\Crm\InventarioStock::likeEscapeSql() === " ESCAPE '!'", 'LIKE usa ESCAPE ! (MariaDB-safe)');
